...
public class Operaciones {
    ...
    public void listadoAsignaturasBDD() throws SQLException {
        ...
        sentenciaSQL="SELECT nombre_asignatura FROM Asignaturas;";
    ...
    public void estudiantesCasa() throws SQLException {
        ...
        sentenciaSQL = "SELECT nombre,apellido FROM Estudiante INNER JOIN Casa ON Estudiante.id_casa=Casa.id_casa WHERE Casa.nombre_casa='" + nombreCasa + "';";
        PreparedStatement sentencia = con2.prepareStatement(sentenciaSQL);
